 ...
 * Agora aceita children para permitir inserir o seletor de abas logo após o título.
 * 
...
const Header = ({ children }) => (
    ...
    <header className={styles.header}>
        ...
        {/* Renderiza o seletor de abas, se fornecido */}
        {children && <div className={styles.tabsInHeader}>{children}</div>}
 ...
 * @param {React.ReactNode} props.headerTabs - O seletor de abas a ser exibido no cabeçalho.
 * @returns {JSX.Element} O elemento JSX que representa o layout completo do dashboard.
 */
const DashboardLayout = ({ children, headerTabs }) => {
    return (
        // Div principal que engloba todo o layout do dashboard.
        <div className={styles.dashboardLayout}>
            {/* Passa headerTabs como children para Header */}
